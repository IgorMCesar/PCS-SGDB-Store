      ...
      <!-- <el-form-item label="Término" required>
        <el-col :span="11">
          <el-form-item prop="date1">
            <el-date-picker type="date" placeholder="Escolha uma Data" v-model="ruleForm.date1" style="width: 100%;"></el-date-picker>
          </el-form-item>
        </el-col>
      </el-form-item> -->
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$electron.ipcRenderer.send('/post/new-product', {
            ...
            this.$electron.ipcRenderer.once('/posted/new-product', (event, response) => {
