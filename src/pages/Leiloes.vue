          ...
          <div class="wrapper">
            ...
            <v-card class="white--text card-size">
              ...
              <v-divider light></v-divider>
                <v-card-actions>
                  <div>R$ {{produtos[i].lanceminimo}}</div>
                  <v-spacer></v-spacer>
                  <v-btn flat class="blue--text">Dar Lance</v-btn>
                </v-card-actions>
            </v-card>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    pegarListaDeProdutos() {
      this.$electron.ipcRenderer.send('/get/auction-list');
      this.$electron.ipcRenderer.once('/got/auction-list', (event, response) => {
